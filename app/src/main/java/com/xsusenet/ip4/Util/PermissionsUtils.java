...
public class PermissionsUtils {
    ...
    public static final int REQUEST_STORAGE_ACAMERA=10;
    public static final int REQUEST_LOCATION_STORAGE =12 ;
    ...
    public static boolean shouldShowRequestStorageandCamera(Activity activity) {
        return (ActivityCompat.shouldShowRequestPermissionRationale(activity,
                Manifest.permission.CAMERA)
                || ActivityCompat.shouldShowRequestPermissionRationale(activity,
                Manifest.permission.READ_EXTERNAL_STORAGE));
    }
    public static boolean shouldShowRequestLocationAndStorage(Activity activity)
    {
        return (ActivityCompat.shouldShowRequestPermissionRationale(activity,
                Manifest.permission.ACCESS_FINE_LOCATION)
                || ActivityCompat.shouldShowRequestPermissionRationale(activity,
    ...
    {
        int res=context.checkCallingOrSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE);
        return (res== PackageManager.PERMISSION_GRANTED);
    }
    public static boolean isLocationPermissionIsGranted(Context context)
    {
        int res=context.checkCallingOrSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    public static boolean checkpermissionforstorageandcamera(Context context)
    {
        int resultCamera = ContextCompat.checkSelfPermission(context, Manifest.permission.CAMERA);
        ...
        return resultCamera== PackageManager.PERMISSION_GRANTED&&
                readexternalstorage== PackageManager.PERMISSION_GRANTED&&writeexternalstorage== PackageManager.PERMISSION_GRANTED;
    }
    public static boolean checkPermissionforLocationAndstorage(Context context)
    {
        int Accessloaction = ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION);
        int FineLocation= ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION);
        int readexternalstorage= ContextCompat.checkSelfPermission(context, Manifest.permission.READ_EXTERNAL_STORAGE);
        int writeexternalstorage= ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        return Accessloaction== PackageManager.PERMISSION_GRANTED&&
                readexternalstorage== PackageManager.PERMISSION_GRANTED&&writeexternalstorage== PackageManager.PERMISSION_GRANTED;
    }
}
